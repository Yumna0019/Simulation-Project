...
function MGSimulate() {
  ...
  const handleSubmit = () => {
    ...
    if (arrivalDistribution === 'Normal' && serviceDistribution === 'Normal') {
      navigate('/GG_with_norm_norm'); // Navigate when conditions are met
    } 
    if (arrivalDistribution === 'Normal' && serviceDistribution === 'Uniform') {
      navigate('/GG_with_norm_uni'); // Navigate when conditions are met
    } 
    if (arrivalDistribution === 'Uniform' && serviceDistribution === 'Uniform') {
      navigate('/GG_with_uni_uni'); // Navigate when conditions are met
    } 
    if (arrivalDistribution === 'Uniform' && serviceDistribution === 'Normal') {
      navigate('/GG_with_uni_norm'); // Navigate when conditions are met
    } 
    else {
